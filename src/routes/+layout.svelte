<script lang="ts">
    ...
    const defaultBannerImage = 'https://pablof7z.com/images/banner.jpg';
...
<div class="relative w-full h-64">
    ...
    <div class="absolute py-6 inset-0 w-full h-full bg-center bg-cover opacity-50 z-0" style={`background-image: url(${bannerImage||defaultBannerImage})`}></div>
    <div class="absolute py-6 inset-0 w-full h-full bg-gradient-to-b from-transparent to-black z-1"></div>
